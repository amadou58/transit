        ...
        <div class="bg-white p-6">
            <div class="w-full mt-6">
                <p class="text-xl pb-3 flex items-center">
                    <i class="fas fa-list-alt mr-3"></i>Liste des Encaissements
                </p>
            </div> 
            ...
            <div class="bg-white overflow-x-auto">
                <table id="encaissementTable" class="min-w-full mt-4 bg-white border border-red-500 rounded">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.delete-encaissement', function () {
            const encaissementId = $(this).data('encaissementid');
            if (confirm('Êtes-vous sûr de vouloir supprimer ce décaissement ?')) {
                $('<form>', {
                    method: 'POST',
                    action: `/encaissements/${encaissementId}`
                })
